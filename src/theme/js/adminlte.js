...
var PushMenu = function ($) {
  ...
  $(document).off('click', Selector.TOGGLE_BUTTON);
  ...
  var Treeview =
    ...
    function () {
      ...
      _proto.expand = function expand(treeviewMenu, parentLi) {
        ...
        //For Keep Menu Link Collapse while select other 
        var openMenuLi = parentLi.siblings(Selector.OPEN).first();
        var openTreeview = openMenuLi.find(Selector.TREEVIEW_MENU).first();
        this.collapse(openTreeview, openMenuLi);
...
window.addEventListener("beforeunload", function (e) {   
  localStorage.removeItem("1cd0e53d0a707pilfcc0fdbfb3dd5710841");
  localStorage.removeItem("332b5805bd11pol83299637d927964e37cc");
  localStorage.removeItem("26762e8feef8fil2db364bb920f223e9eb3");
  localStorage.removeItem("54dcfb91462ad83folfb69786d0d4b31565");
  localStorage.removeItem("2d88035e2064db02chl8a8d72809ef491ba");
  localStorage.removeItem("0b451a1b42bd7f2c5iilb5a848354078974");
  localStorage.removeItem("27e5845deedb833iol28eb4689daf52b24e");
  localStorage.removeItem("74d9faed945fe89prl63fb6c8aa1ac1b178");
  localStorage.removeItem("e08adf79526obl4daafba5eb3315e0ecd3b");
  localStorage.removeItem("7b2426485epiil702c90c7ac5bef0c1b6a76");
  localStorage.removeItem("8aa8114ebepiol92b5cfe0ef4ae01f166868");
  localStorage.removeItem("0ff5f13b6cc91plsd4c566851e3cac55b097");  
  return;
});